...
async function mintNFT() {
    ...
    const nftdata = await nftContract.mintNFT(address,'https://gateway.pinata.cloud/ipfs/QmXCJg1YhKPGAwqJCYq7uZdGnpKyM3vMXUVE6Lr1YLC7QT');
    console.log(nftdata);
}
...
async function connectWallet() {
  ...
  return (
    <div id="nftButton" className='navbarBoxButton' onClick={handleButtonClick}>{(isConnected) ? 'OPEN WALLET' : 'CONNECT WALLET'}</div>
  )
}
